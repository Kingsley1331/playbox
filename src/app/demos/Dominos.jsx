...
{
  /* Unable to render the the point the the pendulum is attached to */
}
{
  /* Also unable to render the connection between the lowest plank and the supporting beam 
  of the box that contains the circles */
}
